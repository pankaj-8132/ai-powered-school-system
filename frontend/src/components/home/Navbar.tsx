    ...
    >
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              AI-Powered<span className="text-[#3ecf8e]"> School Management System</span>
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {/* ✅ Fixed: was a plain <button>, now navigates to /login */}
            <Link
              to="/login"
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-[#1c1c1c] border-b border-gray-200 dark:border-gray-800 px-4 pt-2 pb-6 space-y-4">
          ...
          {/* ✅ Fixed: was a plain <button>, now navigates to /login and closes menu */}
          <Link
            to="/login"
